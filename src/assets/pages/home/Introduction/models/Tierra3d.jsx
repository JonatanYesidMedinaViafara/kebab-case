...
const Tierra3d = (props) => {
    ...
    const { nodes, materials } = useGLTF("/model3D/earth.glb"); // Carga el modelo 3D desde el archivo GLB ubicado en "modelo3D/earth.glb"
...
useGLTF.preload("/model3D/earth.glb");
