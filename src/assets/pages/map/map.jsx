  ...
  return (
    <>
      ...
      <div className="scroll-box">
        ...
        <p>
          Aquí puedes añadir más texto para que el cuadro necesite desplazarse. 
        </p>
        <p>
          Puedes seguir añadiendo más texto para demostrar cómo funciona el desplazamiento dentro del cuadro.
        </p>
        <p>
